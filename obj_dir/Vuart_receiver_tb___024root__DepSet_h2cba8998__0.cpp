...
void Vuart_receiver_tb___024root___eval_triggers__act(Vuart_receiver_tb___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vuart_receiver_tb___024root___eval_triggers__act\n"); );
    // Body
    vlSelf->__VactTriggered.set(0U, ((IData)(vlSelf->uart_receiver_tb__DOT__clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__uart_receiver_tb__DOT__clk__0))));
